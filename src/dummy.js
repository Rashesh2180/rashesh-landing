...
const data = [
  ...
  },
  {
    ...
    priceper_hour: "80",
    priceper_month: "1600",
    img: "https://img.freepik.com/premium-photo/businessman-profile-picture-linkedin_1078199-10524.jpg",
  },
  {
    id: 6,
    name: "Maria Perez",
    ...
    priceper_hour: "100",
    priceper_month: "2000",
    img: "https://img.freepik.com/premium-photo/portrait-woman-data-scientist-working_1078199-10524.jpg",
  },
];
...
const PrequlifiedCarasol = () => {
  ...
  const handleNext = () => {
    // Move to next set of items, make sure it doesn't go beyond the length of data
  ...
  const handlePrev = () => {
    // Move to previous set of items, make sure it doesn't go below 0
    if (currentIndex > 0) {
      setCurrentIndex(currentIndex - 1);
    }
  };
  ...
  return (
    <div className="max-w-[1500px] mx-auto py-20 xl:px-16 lg:px-10 px-5">
      ...
      <div className="mt-10 w-full flex justify-start sm:gap-7 gap-2 items-center">
        ...
        {/* Card container with scrolling effect */}
        <div className="overflow-hidden w-full ">
          <div
            className="flex transition-transform justify-start duration-500 gap-7 p- "
            style={{
