...
const Footer = () => {
  ...
  return (
    <div className=" w-full bg-secondary max-w-[1680px] mx-auto sm:py-14 py-10 xl:px-16 lg:px-10 px-5">
      ...
      <div className=" py-14 flex justify-between gap-5 flex-wrap  ">
        <ul>
          ...
          <div className=" flex justify-between mt-5 gap-2 ">
            ...
            />
            <button className=" py-3 px-7 rounded-[44px] text-[#FFFFFF] bg-footetext capitalize text-sm font-medium font-roboto flex items-center gap-1">
              send{" "}
              <span>
                <img
        ...
        <ul>
          ...
          {[
            ...
            <li className=" text-white font-roboto  text-sm mt-5 bg-[#3b3a3a] py-3 px-4  rounded-xl">
              <NavLink className="flex  gap-3 items-center">
                ...
                <div className=" pl-4 border-l border-bordercolor">
                  <h2 className=" text-xs font-roboto text-white">
                    {ele.text}
                  </h2>
                  <h2 className="text-base font-roboto text-white font-medium">
                    {ele.title}
                  </h2>
                </div>
              </NavLink>
