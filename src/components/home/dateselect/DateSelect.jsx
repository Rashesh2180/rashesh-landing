      ...
      <div className="bg-custom max-lg:py-10 ">
        <div className="flex  mx-auto max-w-[1440px] max-lg:flex-col xl:px-32 sm:px-10 px-5 xl:gap-40  max-sm:gap-5 gap-10">
          <div className=" lg:py-20 max-lg:pt-40 flex-1">
            ...
            />
            <h1 className=" font-raleway font-bold text-5xl  leading-[50px]">
          ...
          <div className="flex-1 bg-white shadow-2xl rounded-[30px] border-t-4 relative lg:bottom-36 border-primary xl:p-7 p-5">
            ...
            <div className=" mt-5">
              ...
              <div className=" mt-4 flex justify-between xl:gap-3 gap-2 items-center">
                <button className=" border border-bordercolor py-2 font-sm max-sm:text-xs shadow-sm xl:px-4 px-3 rounded-[10px]">
                  10 : 45 AM
                </button>
                <button className=" border border-primary text-primary py-2 font-sm max-sm:text-xs  shadow-sm xl:px-4 px-3  rounded-[10px]">
                  11 : 30 AM
                </button>
                <button className=" border border-bordercolor py-2 font-sm shadow-sm max-sm:text-xs   xl:px-4 px-3  rounded-[10px]">
                  12 : 15 AM
                </button>
                <button className=" border border-bordercolor py-2 font-sm shadow-sm max-sm:text-xs  xl:px-4 px-3  rounded-[10px]">
                  01 : 00 AM
            ...
            <div className="mt-5">
            <h3 className=" font-roboto font-bold text-base">Select time of day</h3>
           <select className=" w-full outline-none mt-4  " >
           <option value="" className=" ">(GMT+5:30) Chennai, Kolkata, Mumbai, new Delhi (IST)</option>
